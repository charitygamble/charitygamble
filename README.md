...
Welcome to my GitHub profile! I am a front-end web developer who loves to create responsive, accessible websites. My main focus is building fast, accessible, static sites using the [Build Awesome](https://11ty.dev) static site generator. However, I am always looking to learn new technologies. For repositories, please go to [ReaperForge](https://reaperforge.org/cgambledev)
